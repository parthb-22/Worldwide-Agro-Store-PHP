    ...
    <div class="container">
      <div class="row g-5 align-items-center">
        <div class="col-lg-6 text-center text-lg-start">
          ...
          <a href="product.php" class="btn btn-dark py-2 px-4 me-3 animated slideInRight">Shop Now</a>
          <a href="contact.php" class="btn btn-outline-dark py-2 px-4 animated slideInRight">Contact Us</a>
        </div>
        <div class="col-lg-6">
          <img class="img-fluid animated pulse infinite" src="./img/turmeric-powder.png" alt="" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row g-5 align-items-center">
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
          <img class="img-fluid animated pulse infinite" src="./img/tumeric-img.png" style="height: 500px" />
        </div>
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
          <h1 class="text-primary mb-4">
            Worldwide Agro
            <span class="fw-light text-dark">The Promise of Flavour & Health</span>
          </h1>
          <p class="mb-4">
          ...
          <a class="btn btn-primary py-2 px-4" href="/product.php">Shop Now</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid py-5">
    <div class="container">
      ...
      <div class="row g-4 align-items-center">
          ...
          <div class="row g-5">
            <div class="col-12 d-flex">
              ...
              <div class="ps-3">
                ...
                <span>"Explore the exceptional qualities of our आदर्श हळद पावडर
                  (सेलम)"
                </span>
              </div>
            </div>
            <div class="col-12 d-flex">
              ...
              <div class="ps-3">
                ...
                <hr class="w-25 bg-primary my-2" />
                <span>"Discover the outstanding attributes of our आदर्श हळद पावडर
                  (सेलम)"
                </span>
              </div>
            </div>
            <div class="col-12 d-flex">
              ...
              <div class="ps-3">
                <h5>Low Fat</h5>
                <hr class="w-25 bg-primary my-2" />
                <span>"Unveil the remarkable qualities of our आदर्श हळद पावडर
                  (सेलम)"</span>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
          <img class="img-fluid animated pulse infinite" src="./img/turmeric-powder.png" />
        </div>
        <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
          <div class="row g-5">
            <div class="col-12 d-flex">
              ...
              <div class="ps-3">
                ...
                <hr class="w-25 bg-primary my-2" />
                <span>"Delve into the exceptional qualities of our 'आदर्श हळद
            ...
            <div class="col-12 d-flex">
              ...
              <div class="ps-3">
                ...
                <hr class="w-25 bg-primary my-2" />
                <span>"Celebrate the remarkable qualities of our आदर्श हळद पावडर
                  (सेलम)"</span>
              </div>
            </div>
            <div class="col-12 d-flex">
              ...
              <div class="ps-3">
                ...
                <hr class="w-25 bg-primary my-2" />
                <span>"Explore the distinctive qualities of our आदर्श हळद पावडर
                  (सेलम)"
                </span>
              </div>
            </div>
    ...
    <div class="container text-white py-5">
      <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px">
        <h1 class="text-white mb-3">
          Our Customer Said
          <span class="fw-light text-dark">About Our Natural Turmeric Powder</span>
        </h1>
        <!-- <p class="mb-5">
        ...
        <div class="col-lg-8">
          <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.1s">
            <div class="testimonial-item text-center" data-dot="1">
              <img class="img-fluid border p-2" src="img/customer-1.png" alt="" />
            ...
            <div class="testimonial-item text-center" data-dot="2">
              <img class="img-fluid border p-2" src="img/customer-2.png" alt="" />
              <h5 class="fw-light lh-base text-white">
            ...
            <div class="testimonial-item text-center" data-dot="3">
              <img class="img-fluid border p-2" src="img/customer-3.png" alt="" />
              <h5 class="fw-light lh-base text-white">
